...
- [x] 4. Define GraphQL schema
  ...
  - [x] 4.1 Create type definitions
    ...
    - _Requirements: 11.3_
  - [x] 4.2 Define queries and mutations
...
- [x] 5. Implement GraphQL resolvers for CRUD operations

  - [x] 5.1 Implement profile resolvers
  ...
  - [x] 5.2 Implement experience resolvers
...
- [x] 7. Implement Anthropic service for AI generation

  - [x] 7.1 Create Anthropic client wrapper
  ...
  - [x] 7.2 Implement prompt builders
    ...
    - _Requirements: 6.1, 7.1, 8.1_
  - [x] 7.3 Implement career data fetcher
    - Create function to fetch all career data for AI context
    - Include profile, experiences, skills, projects
    - _Requirements: 6.1, 7.1, 8.1_

- [x] 8. Implement AI generation resolvers

  - [x] 8.1 Implement resume generation resolvers
...
- [x] 9. Implement error handling
  ...
  - [x] 9.1 Create GraphQL error formatters
...
- [x] 10. Create Fastify server and Lambda handler

  - [x] 10.1 Set up Fastify with Mercurius
...
- [x] 12. Set up build and deployment

  - [x] 12.1 Configure build process
    ...
    - _Requirements: 10.1_
  - [x] 12.2 Create PR validation workflow
